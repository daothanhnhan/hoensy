...
class action_email 
{
        function email_send ($email_to, $title = "", $content = "") {
                $nFrom = "VYHOFOCO SHOEMAKER";    //mail duoc gui tu dau, thuong de ten cong ty ban
        ...
        function lien_he () {
            global $conn_vn;
                if (isset($_POST['lien_he'])) {
                        ...
                        //echo $str;die;
                        $this->email_send($email, "Thông Tin Khách Hàng Từ Vinhomes", $str);
                        echo '<script type="text/javascript">alert(\'Bạn đã đăng ký nhận tư vấn thành công.\');</script>';
                }
        }
