...
if (isset($_POST['send_mail'])){
    ...
    $gui_mail = $mail->email_send($email, "Thông Tin Đặt Hàng Từ OF'H Cosmetic",$content);
?>
                                                ...
                                                <div class="vk-checkout-order-paypal">
                                                    <div id="order_review" class="woocommerce-checkout-review-order">
                                                        ...
                                                        <div class="form-row place-order">
                                                            <button type="submit" name="send_mail" class="btn btn-primary" id="submitPayment" style="padding:3px 30px; font-weight:bold; font-size:16px; margin-bottom:15px;background-color:#52c3c1; border:1px solid #fff;" ><?php if($lang == "vn"){echo "Hoàn tất mua hàng";}else{echo "Complete Shopping";}?></button>
