        ...
        <div class="coverWeb">
            ...
            if (isset($_GET["page"])) {
                switch ($_GET["page"]) {
                    ...
                    //////////// dat dich vụ //////////////
                    case "dat-dich-vu":
                        include_once("template/dat-dich-vu/dat-dich-vu.php");
                        break;
                    case "dich-vu-dat":
                        include_once("template/dat-dich-vu/dich-vu-dat.php");
                        break;
                    //////////// menu sp hot //////////////
                    case "menu-sp-hot":
                        include_once("template/menu-sp-hot/menu-sp-hot.php");
                        break;
                    case "them-menu-sp-hot":
                        include_once("template/menu-sp-hot/them-menu-sp-hot.php");
                        break;
                    case "sua-menu-sp-hot":
                        include_once("template/menu-sp-hot/sua-menu-sp-hot.php");
                        break;
                    case "xoa-menu-sp-hot":
                        include_once("template/menu-sp-hot/xoa-menu-sp-hot.php");
                        break;
                    //////////// menu dv hot //////////////
                    case "menu-dv-hot":
                        include_once("template/menu-dv-hot/menu-dv-hot.php");
                        break;
                    case "them-menu-dv-hot":
                        include_once("template/menu-dv-hot/them-menu-dv-hot.php");
                        break;
                    case "sua-menu-dv-hot":
                        include_once("template/menu-dv-hot/sua-menu-dv-hot.php");
                        break;
                    case "xoa-menu-dv-hot":
                        include_once("template/menu-dv-hot/xoa-menu-dv-hot.php");
                        break;
                    ///////////// chuong //////////////////
                    case "chuong":
                        include_once("template/chuong/chuong.php");
                        break;
                    case "them-chuong":
                        include_once("template/chuong/them-chuong.php");
                        break;
                    case "sua-chuong":
                        include_once("template/chuong/sua-chuong.php");
                        break;
                    case "xoa-chuong":
                        include_once("template/chuong/xoa-chuong.php");
                        break;
                    /////////////// bài ///////////////////
                    case "bai":
                        include_once("template/bai/bai.php");
                        break;
                    case "them-bai":
                        include_once("template/bai/them-bai.php");
                        break;
                    case "sua-bai":
                        include_once("template/bai/sua-bai.php");
                        break;
                    case "xoa-bai":
                        include_once("template/bai/xoa-bai.php");
                        break;
                    ///////////// link bài ///////////////
                    case "link-bai":
                        include_once("template/link-bai/link-bai.php");
                        break;
                    case "them-link-bai":
                        include_once("template/link-bai/them-link-bai.php");
                        break;
                    case "sua-link-bai":
                        include_once("template/link-bai/sua-link-bai.php");
                        break;
                    case "xoa-link-bai":
                        include_once("template/link-bai/xoa-link-bai.php");
                        break;
                    ////////////// user  //////////////////
                    case "xoa-user":
                        ...
                        break;
                    case "user-kich-hoat":
                        include_once("template/tai-khoan-user/user-kich-hoat.php");
                        break;
                    ////////////// dang ky ////////////////
                    case "nhan-tin":
                        include_once("template/dang-ky/nhan-tin.php");
                        break;
                    ///////////// Default /////////////////
                    default:
