...
class action_page extends library{
	...
	/*--------------- Sản phẩm --------------------*/
		...
		public function addProduct(){
			...
			$picture_size = isset($_POST['picture_size']) ? $_POST['picture_size'] : '';

			$picture_size_1 = isset($_POST['picture_size_1']) ? $_POST['picture_size_1'] : '';

			$picture_size_2 = isset($_POST['picture_size_2']) ? $_POST['picture_size_2'] : '';

			$picture_size_3 = isset($_POST['picture_size_3']) ? $_POST['picture_size_3'] : '';

			$service_hot = isset($_POST['service_hot']) ? $_POST['service_hot'] : '0';
   ...
   //          }
	  ...
	  //   	if(isset($_FILES['fileUpload2']) && $_FILES['fileUpload2']['name'] != ""){
			...
			$insert = $this->Insert_1('product', 
									   ...
									   'sssssssdddsssisiiissssssssssssssssiissssssssi');
   ...
   //          }
			...
			if (!$this->Update_1('product',
								  ...
								  'sssssssdddsssisiiissssssssssssssssiisissssssssi')) {
...
/*---------------- Danh mục dịch vụ --------------------*/
	...
	/*------------------ dịch vụ -------------------*/
		...
		public function addService(){
			...
			$price_nho = isset($_POST['price_nho']) ? $_POST['price_nho'] : '0';

			$price_vua = isset($_POST['price_vua']) ? $_POST['price_vua'] : '0';

			$price_lon = isset($_POST['price_lon']) ? $_POST['price_lon'] : '0';

			$price_dac_biet = isset($_POST['price_dac_biet']) ? $_POST['price_dac_biet'] : '0';
