<?php 
	...
	function menu_sp_hot () {
		...
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "INSERT INTO menu_sp_hot (productcat_id, parent, sort) VALUES ('$productcat_id', '$parent', '$sort')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một menu.\');window.location.href="index.php?page=menu-sp-hot"</script>';
			} else {
