<?php 
	...
	function menu_dv_hot ($id) {
		...
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "UPDATE menu_dv_hot SET productcat_id = '$productcat_id', parent = '$parent', sort = '$sort' WHERE id = $id";
	...
	$info = $action->getDetail('menu_dv_hot', 'id', $_GET['id']);
?>
