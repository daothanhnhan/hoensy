...
<form action="" method="post" accept-charset="utf-8" id="updateProductCat">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor1" name="productcat_des" ><?= $row_showMain['lang_productcat_des'];?></textarea></p>
            <p class="titleRightNCP">Link</p>
            <input type="text" class="txtNCP1" name="productcat_sub_info1" value="<?= $row_showMain['lang_productcat_sub_info1'];?>">
