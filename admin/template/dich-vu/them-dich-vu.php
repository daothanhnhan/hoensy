        ...
        <div class="boxNodeContentPage">
            ...
            <div class="rowNCP">
                <div class="subColContent">
                    ...
                    <input type="number" class="txtNCP1" value="" name="price_nho"/>
                </div>
                <div class="subColContent">
                    <p class="titleRightNCP" >Giá vừa</p>
                    <input type="number" class="txtNCP1" value=">" name="price_vua"/>
                </div>
                <div class="subColContent">
                    <p class="titleRightNCP" >Giá lớn</p>
                    <input type="number" class="txtNCP1" value=">" name="price_lon"/>
                </div>
                <div class="subColContent">
                    <p class="titleRightNCP" >Giá đặc biệt</p>
                    <input type="number" class="txtNCP1" value="" name="price_dac_biet"/>
                </div>
                <div class="subColContent">
