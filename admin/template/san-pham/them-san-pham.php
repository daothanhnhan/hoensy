        ...
        <div class="boxNodeContentPage">
            ...
            <div class="rowNCP">
                <!-- <div class="subColContent" >
                    ...
                    <input type="text" class="txtNCP1" value="<?php echo $rowPro['picture_size'];?>" name="picture_size"/>
                ...
                <div class="subColContent" >
                    ...
                    <input type="text" class="txtNCP1" value="<?php echo $rowPro['picture_size_1'];?>" name="picture_size_1"/>
            ...
            <div class="rowNCP">
                <!-- <div class="subColContent" >
                    ...
                    <input type="text" class="txtNCP1" value="<?php echo $rowPro['picture_size_2'];?>" name="picture_size_2"/>
                ...
                <div class="subColContent" >
                    ...
                    <input type="text" class="txtNCP1" value="<?php echo $rowPro['picture_size_3'];?>" name="picture_size_3"/>
