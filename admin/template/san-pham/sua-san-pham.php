...
<form action="" method="post" enctype="multipart/form-data" id="updateProduct">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <br>
            <br>
            <a href="index.php?page=chuong&product_id=<?= $row['product_id'] ?>" title="" class="quan-ly">Quản lý Chương</a>
           ...
           <p class="titleRightNCP">Link</p>
            <input type="text" class="txtNCP1" name="product_sub_info1" value="<?php echo $row['product_sub_info1'];?>" />

            <p class="titleRightNCP">Video:</p>
            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor11" name="product_sub_info2"><?php echo $row_showMain['lang_product_sub_info2'];?></textarea></p>
    ...
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            <span class="titLeftNCP">Banner quảng cáo</span>
        ...
        <div class="boxNodeContentPage">
            <div id="wrapper">
                ...
                <div id="image-holder">
                <?php 
                    if ($row['product_img_qc'] != '') {
                    ?>
                        <img src="../images/<?= $row['product_img_qc']?>" class="img-responsive" alt="Image" width="300">
                        <input type="hidden" name="product_img_qc" value="<?= $row['product_img_qc']?>">
                    <?php
                    }
                ?>                
                </div>
        ...
        <div class="boxNodeContentPage">
            ...
            <div class="rowNCP">
             ...
             <div class="rowNCP">
                ...
                <div class="subColContent">
                    ...
                    <p class="titleRightNCP">Tiến độ</p>
            ...
            <!-- <div class="rowNCP">
                <div class="subColContent" >
                    ...
                    <p class="titleRightNCP">Kích thước tranh 1</p>

                    <input type="text" class="txtNCP1" value="<?php echo $row['picture_size'];?>" name="picture_size"/>

                </div>  
                <div class="subColContent" >

                    <p class="titleRightNCP">Kích thước tranh 2</p>

                    <input type="text" class="txtNCP1" value="<?php echo $row['picture_size_1'];?>" name="picture_size_1"/>
            ...
            <!-- <div class="rowNCP">
                <div class="subColContent" >
                    ...
                    <p class="titleRightNCP">Kích thước tranh 3</p>

                    <input type="text" class="txtNCP1" value="<?php echo $row['picture_size_2'];?>" name="picture_size_2"/>

                </div>  
                <div class="subColContent" >

                    <p class="titleRightNCP">Kích thước tranh 4</p>

                    <input type="text" class="txtNCP1" value="<?php echo $row['picture_size_3'];?>" name="picture_size_3"/>

                </div> 
            </div> -->

             <!-- <p class="titleRightNCP"><a style="color: #000;padding: 10px;background: #e6e6e6;" href="/admin/?page=mau-san-pham&id=<?= $product_id ?>">Quản lý tranh bán lẻ (Bán theo từng bức tranh)</a></p> -->
            <!-- <div class="rowNCP">
        ...
        <div class="boxNodeContentPage">
            ...
            <div>
                ...
                <label class="selectCate">
                    ...
                    <input type="checkbox" value="1" name="home" <?= $row['home'] == 1 ? 'checked' : '' ?>>Trang chủ
            ...
            <div>
                ...
                <label class="selectCate">
                    ...
                    <input type="checkbox" value="1" name="service_hot" <?= $row['service_hot'] == 1 ? 'checked' : '' ?>>Dịch vụ nổi bật
