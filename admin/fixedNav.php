    ...
    <div class="contentFL">
        <ul class="listMenuFL">
           ...
           <li><a href="index.php?page=bai-viet" title=""
            ...
            <!-- <li><a href="index.php?page=dat-dich-vu" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đặt dịch vụ</a>
            </li>

            <li><a href="index.php?page=menu-sp-hot" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Sản phẩm nổi bật</a>
            </li>

            <li><a href="index.php?page=menu-dv-hot" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Dịch vụ nổi bật</a>
            </li> -->
